...
# 3. Criar o Boxplot COM mostrar outliers
plt.figure(figsize=(6, 4))                  # Define tamanho do gráfico
plt.boxplot(dados, showfliers=True)         # "showfliers=True" mostra os outliers (padrão)
plt.title("Boxplot - Home Yellow (com outliers)")  # Título do gráfico
